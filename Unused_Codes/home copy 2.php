...
if (!isset($_SESSION['user_id'])) {
    ...
    // nasa loob ng index.php yung login form
    exit();
}
...
<button class="btn btn-outline-success m-2" id="sidebarToggle">
    <i class="fa fa-bars"></i>
</button>
<div class="container-fluid">
    <div class="row">
        <!-- Sidebar -->
        <nav id="sidebar" class="col-md-3 col-lg-2 bg-success p-3 min-vh-100 border border-2 border-dark">
...
$(document).ready(function () {
    ...
    $("#main-content").toggleClass("main-full-width");
});
