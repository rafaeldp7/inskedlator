...
class ScheduleModel
{
    ...
    public function addSchedule($user_id, $shift, $day, $time)
    {
        // Sanitize inputs
        ...
        $checkStmt->bind_param("sss", $shift, $day, $time);
        $checkStmt->execute();
        ...
        $insertSql = "
            INSERT INTO schedules
                (user_id, shift, day, time, status)
            VALUES (?, ?, ?, ?, ?)
        ";
        $stmt = $this->conn->prepare($insertSql);
        $stmt->bind_param("issss", $user_id, $shift, $day, $time, $status);
    ...
    public function getSchedules($sort_by = 'shift', $order = 'asc', $status = 'all') {
        $validSortColumns = ['shift', 'day', 'time', 'status'];
    ...
    public function getSchedulesAdmin($sort_by = 'shift', $order = 'asc', $status = 'all') {
        ...
        $allowed_columns = ['shift', 'day', 'time', 'status'];
